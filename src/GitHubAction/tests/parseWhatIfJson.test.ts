...
describe('GitHub Action - JSON Parser Tests', function () {
    ...
    describe('Valid JSON Parsing', function () {
        it('should parse empty what-if JSON successfully', function () {
            ...
            const result = parseWhatIfJson(jsonString);
        ...
        it('should parse complex what-if JSON with all change types', function () {
            ...
            const changeTypes = result.changes.map((c: any) => c.changeType);
            ...
            const modifyChange = result.changes.find((c: any) => c.changeType === 'Modify');
            ...
            const unsupportedChange = result.changes.find((c: any) => c.changeType === 'Unsupported');
    ...
    describe('Error Handling', function () {
        ...
        it('should throw error for undefined input', function () {
            try {
                parseWhatIfJson(undefined as any);
                assert.fail('Should have thrown an error');
            } catch (error) {
                assert.strictEqual(error instanceof Error, true);
                assert.strictEqual((error as Error).message.includes('Failed to parse what-if JSON'), true);
    ...
    describe('Performance and Robustness', function () {
        it('should handle large JSON strings efficiently', function () {
            ...
            const result = parseWhatIfJson(largeJson);
        ...
        it('should handle JSON with deeply nested structures', function () {
            ...
            const result = parseWhatIfJson(complexJson);
            assert.strictEqual(typeof result, 'object');
        ...
        it('should handle JSON with special characters and unicode', function () {
            ...
            const result = parseWhatIfJson(jsonWithSpecialChars);
            assert.strictEqual(typeof result, 'object');
