...
.bolt-button.subtle {
    ...
    &:focus {
        @include theme-high-contrast {
            border: 1px solid $focus-border-color;
            outline: 4px solid $communication-foreground;
        }
    }
...
// TODO: Fix selector after resolving fluent-icons-enabled requirement for Fluent Icons re: PR #740643
// Original selector: .bolt-icon:not(.icon-only) > .left-icon
