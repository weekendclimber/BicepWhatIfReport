...
export function addColorClass(color) {
    ...
    var className = "bg-".concat(color);
    var selector = ".".concat(className, " .bolt-dropdown-expandable-textfield-input");
    ...
    styleSheet.insertRule("".concat(selector, " { background-color: #").concat(color, "; }"));
    return className;
}
/**
