...
export declare class ContextMenuBehavior implements IBehavior<{}, {}> {
    ...
    private allowDefaultMenuOnAnchor;
    constructor(contextMenuHandler: (event: React.MouseEvent<HTMLElement, MouseEvent> | React.KeyboardEvent<HTMLElement>) => void, allowDefaultMenuOnAnchor?: boolean);
